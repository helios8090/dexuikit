...
var WalletButton = function (_a) {
    ...
    var internalProps = external ? getExternalLinkProps() : {};
    var isDisabled = isLoading || disabled;
    return (React.createElement(StyledButton, __assign({}, internalProps, props, { isLoading: isLoading, disabled: isDisabled, size: "sm", style: { position: "relative", overflow: "hidden", justifyContent: "space-between", borderRadius: "20px", height: "64px", color: "#101035", fontWeight: 700 } }),
        React.isValidElement(startIcon) &&
            React.cloneElement(startIcon, {
                mr: "0.5rem",
            }),
...
var WalletCard = function (_a) {
    ...
    return (React.createElement(WalletButton, { fullWidth: true, variant: "tertiary", onClick: function () {
        ...
        React.createElement(Icon, { width: "47px" })));
};
